...
salario = float(input("Digite o sálario fixo: "))
vendas = float(input("Digite o total de vendas desse mês: "))

#Calcular comissão
percentual = 0.15
comissão = vendas * percentual
...
Total de vendas: R${vendas:.2f}
Comissão: R${comissão:.2f}
